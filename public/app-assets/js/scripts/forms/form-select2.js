...
(function (window, document, $) {
  ...
  singleSelect.wrap('<div class="position-relative"></div>').select2({
    dropdownAutoWidth: true,
    width: '100%',
    maximumSelectionLength: 1,
    dropdownParent: singleSelect.parent(),
    placeholder: 'Select maximum 1 item'
  });
  ...
  customerSelect.wrap('<div class="position-relative"></div>').select2({
    dropdownAutoWidth: true,
