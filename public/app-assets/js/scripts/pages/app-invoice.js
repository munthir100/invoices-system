...
$(function () {
  ...
  if (select2.length) {
    ...
    select2.on('change', function () {
      var selectedCustomerData = $(this).find('option:selected').data('customer');

      // Render customer details
      var renderDetails =
        '<div class="customer-details mt-1">' +
        '<p class="mb-25">Name: ' + selectedCustomerData.name + '</p>' +
        '<p class="mb-25">Type: ' + selectedCustomerData.type + '</p>' +
        '<p class="mb-25">Tel: ' + selectedCustomerData.phone + '</p>' +
        '<p class="mb-25">Language: ' + selectedCustomerData.language + '</p>' +
        '</div>';
