                                ...
                                <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                    <div>
                                        <div class="logo-wrapper">
                                            ...
                                            <h3 class="text-primary invoice-logo">Apostrophe</h3>
                                        </div>
                                    ...
                                    <div class="invoice-number-date mt-md-0 mt-2">
                                        <div class="d-flex align-items-center justify-content-md-end mb-1">
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group">
                                                ...
                                                <input name="number" type="text" class="form-control invoice-edit-input" placeholder="53634" />
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mb-1">
                                            <span class="title">Date:</span>
                                            <input name="date" type="text" class="form-control invoice-edit-input date-picker" />
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <span class="title">Due Date:</span>
                                            <input name="due_date" type="text" class="form-control invoice-edit-input due-date-picker" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row row-bill-to invoice-spacing">
                                    <div class="col-xl-8 mb-lg-1 col-bill-to ps-0">
                                        ...
                                        <div class="invoice-customer">
                                            <select name="customer_id" class="invoiceto form-select">
                                                <option></option>
                                                @foreach($customers as $customer)
                                                <option value="{{$customer->id}}" data-customer="{{ json_encode($customer) }}">{{$customer->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end item-options-menu p-50" aria-labelledby="dropdownMenuButton">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input name="discount" type="number" class="form-control" id="discount-input" />
                                                                </div>
...
<link rel="stylesheet" type="text/css" href="../../../app-assets/css-rtl/pages/app-invoice.css">
@endsection
