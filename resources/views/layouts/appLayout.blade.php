...
<head>
    ...
    <meta name="description" content="Apostrophe admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, Apostrophe admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title>Bootstrap Tables - Apostrophe - Bootstrap HTML admin template</title>
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon" data-feather="search"></i></a>
                    <div class="search-input">
                        ...
                        <input class="form-control input" type="text" placeholder="Explore Apostrophe..." tabindex="-1" data-search="search">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="../../../html/rtl/vertical-menu-template/index.html"><span class="brand-logo">
                        ...
                        <h2 class="brand-text">Apostrophe</h2>
                    </a></li>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="{{ request()->is('dashboard') ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{route('dashboard')}}">
                        ...
                        <span class="menu-item text-truncate" data-i18n="Home">
                            Home
                        </span>
                    </a>
                </li>
                ...
                <li class="{{ request()->is('administrators*') ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{route('administrator.administrators.index')}}">
                        <i data-feather='user-check'></i>
                        <span class="menu-item text-truncate" data-i18n="Administrators">
                            Administrators
                        </span>
                    </a>
                </li>
                ...
                <li class="{{ request()->is('invoices*') ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{route('user.invoices.index')}}">
                        ...
                        <span class="menu-item text-truncate" data-i18n="Invoices">
                            Invoices
                        </span>
                    </a>
                </li>
                <li class="{{ request()->is('customers*') ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{route('user.customers.index')}}">
                        <i data-feather='users'></i>
                        <span class="menu-item text-truncate" data-i18n="Customers">
                            Customers
                        </span>
                    </a>
                </li>
